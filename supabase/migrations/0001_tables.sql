...
CREATE TABLE IF NOT EXISTS "public"."apartment_coordinates" (
    "apartment_id" bigint NOT NULL,
    "lat" double precision,
    "lon" double precision
);

ALTER TABLE "public"."apartment_coordinates" ALTER COLUMN "apartment_id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."apartment_coordinates_apartment_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY "public"."apartment_coordinates"
    ADD CONSTRAINT "apartment_coordinates_pkey" PRIMARY KEY ("apartment_id");
...
ALTER TABLE ONLY "public"."apartment_coordinates"
    ADD CONSTRAINT "apartment_coordinates_apartment_id_fkey" FOREIGN KEY ("apartment_id") REFERENCES "public"."apartments"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."chat_rooms"
    ADD CONSTRAINT "chat_rooms_owner_id_fkey" FOREIGN KEY ("owner_id") REFERENCES "public"."users"("id") ON DELETE CASCADE;
